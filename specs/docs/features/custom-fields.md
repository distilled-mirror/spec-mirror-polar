...
Custom Fields are enabled on Checkout specifically on each **product**. While [creating or updating](/docs/features/products) a product, expand the **Checkout Page** section and select the fields you want to include under **Checkout Fields**.
