...
The first step is to [create a Checkout session](/docs/api-reference/checkouts/create-checkout-session). For this you'll need at least your **Product ID**.
...
For the complete schema of each price type, refer to the [Checkout API reference](/docs/api-reference/checkouts/create-checkout-session).
