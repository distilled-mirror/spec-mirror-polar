...
[Wallet payment methods](/docs/features/checkout/payment-methods#cards-and-wallets), such as Apple Pay and Google Pay, are not enabled by default when you embed checkout on your website. For security reasons, your website domain must be validated first. This applies to Embedded Checkout only — on Polar's hosted checkout, wallets work out of the box with nothing to configure.
