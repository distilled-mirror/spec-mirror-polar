...
````yaml /openapi/2026-04.openapi.json patch /v1/subscriptions/{id}
openapi: 3.1.0
info:
  title: Polar API
  ...
  /v1/subscriptions/{id}:
    patch:
      ...
      responses:
        ...
        '409':
          description: >-
            Subscription is pending an update, or is not scheduled to be
            canceled.
          content:
            application/json:
              schema:
                anyOf:
                  ...
                  - $ref: '#/components/schemas/SubscriptionNotScheduledToCancel'
                title: Response 409 Subscriptions:Update
        '422':
  ...
  schemas:
    SubscriptionUpdate:
      anyOf:
        ...
        - $ref: '#/components/schemas/SubscriptionUpdateUnits'
    ...
    SubscriptionNotScheduledToCancel:
      properties:
        error:
          type: string
          const: SubscriptionNotScheduledToCancel
          title: Error
          examples:
            - SubscriptionNotScheduledToCancel
        detail:
      ...
      required:
        - error
        - detail
      title: SubscriptionNotScheduledToCancel
    HTTPValidationError:
      properties:
        detail:
          items:
      ...
      properties:
        ...
        proration_behavior:
          anyOf:
            ...
            - type: 'null'
          description: >-
            Determine how to handle the proration billing. If not provided, will
            use the default organization setting.
        discount_id:
          anyOf:
            - type: string
              format: uuid4
          ...
          title: Discount Id
          description: >-
            Update the subscription to apply a new discount. If set to `null`,
            the discount will be removed. The change will be applied on the next
            billing cycle.
        trial_end:
          anyOf:
            - type: string
    ...
    SubscriptionUpdateBillingPeriod:
      properties:
        current_billing_period_end:
          ...
          description: >-
            Set a new date for the end of the current billing period. The
            subscription will renew on this date. The new date can be earlier or
            later than the current period end, as long as it's in the future.


            If the subscription is set to cancel at the end of the period, it'll
            end on this new date instead.


            It is not possible to update the current billing period on a
            subscription that's already revoked or not active.
          examples:
            - '2026-01-01T00:00:00.000000Z'
      additionalProperties: false
      type: object
      ...
      properties:
        customer_cancellation_reason:
          ...
          description: >-
            ...
            Only set this in case your own service is requesting the reason from
            the

            customer. Or you know based on direct conversations, i.e support,
            with
      ...
      properties:
        ...
        resumes_at:
          ...
          description: >-
            ...
            If not set, the subscription stays paused until it is resumed
            manually.
    ...
    SubscriptionUpdateClear:
      properties:
        pending_update:
          ...
          description: >-
            Clear the pending subscription update. Set to null to remove
            scheduled changes.
      additionalProperties: false
      type: object
      required:
