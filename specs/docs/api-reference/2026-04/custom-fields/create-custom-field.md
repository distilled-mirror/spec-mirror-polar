...
````yaml /openapi/2026-04.openapi.json post /v1/custom-fields/
openapi: 3.1.0
info:
  title: Polar API
      ...
      properties:
        ...
        slug:
          ...
          description: >-
            ...
            the value. Must be unique across the organization.It can only
        ...
        organization_id:
          ...
          description: >-
            The ID of the organization owning the custom field. **Required
