...
````yaml /openapi/2026-04.openapi.json patch /v1/customer-portal/subscriptions/{id}
openapi: 3.1.0
info:
  title: Polar API
      ...
      responses:
        ...
        '403':
          description: >-
            ...
            the period, the user lacks billing permissions, or pausing/resuming
            ...
            application/json:
              schema:
                anyOf:
                  ...
                  - $ref: '#/components/schemas/UpdateSubscriptionPlanNotAllowed'
                  - $ref: '#/components/schemas/UpdateSubscriptionSeatsNotAllowed'
                  - $ref: '#/components/schemas/UpdateSubscriptionUnitsNotAllowed'
        ...
        '409':
          description: >-
            The subscription has no payment method to charge, or is not
          ...
          content:
            application/json:
              schema:
                ...
                title: Response 409 Customer Portal:Subscriptions:Update
        '422':
  ...
  schemas:
    CustomerSubscriptionUpdate:
      anyOf:
        ...
        - $ref: '#/components/schemas/CustomerSubscriptionUpdateUnits'
    ...
    UpdateSubscriptionUnitsNotAllowed:
      properties:
        error:
          type: string
          const: UpdateSubscriptionUnitsNotAllowed
          title: Error
          examples:
            - UpdateSubscriptionUnitsNotAllowed
        detail:
      ...
      required:
        - error
        - detail
      title: UpdateSubscriptionUnitsNotAllowed
    ResourceNotFound:
      properties:
        error:
          type: string
    ...
    CustomerSubscriptionUpdateUnits:
      ...
      required:
        - units
      title: CustomerSubscriptionUpdateUnits
