...
````yaml /openapi/2026-10.openapi.json patch /v1/custom-fields/{id}
openapi: 3.1.0
info:
  title: Polar API
        ...
        slug:
          anyOf:
            - type: string
              ...
              pattern: ^[a-z0-9-_]+$
              description: >-
                Identifier of the custom field. It'll be used as key when
                storing the value. Must be unique across the organization.It can
