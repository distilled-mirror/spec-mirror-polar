...
````yaml /openapi/2026-10.openapi.json patch /v1/products/{id}
openapi: 3.1.0
info:
  title: Polar API
      ...
      properties:
        ...
        recurring_interval:
          ...
          description: >-
            ...
            one-time purchase. **Can only be set on legacy recurring products.
        ...
        recurring_interval_count:
          ...
          description: >-
            ...
            2 it will be every other month, and so on. Once set, it can't be
            changed.**
        is_archived:
          anyOf:
            - type: boolean
        ...
        prices:
          ...
          title: Prices
          description: >-
            List of available prices for this product. If you want to keep
            existing prices, include them in the list as an
            `ExistingProductPrice` object.
        medias:
          anyOf:
            - items:
                type: string
