...
````yaml /openapi/2026-10.openapi.json get /v1/customers/external/{external_id}/members
openapi: 3.1.0
info:
  title: Polar API
      ...
      x-codeSamples:
        - lang: python
          source: |
            ...
            for item in polar.customers.members.iter_list_external(
                'string',
                page=1,
                limit=10,
                sorting=['-created_at'],
        ...
        - lang: typescript
          source: |
            ...
            for await (const item of polar.customers.members.iterListExternal(
              "string",
              {
                "page": 1,
                "limit": 10,
